...
IF OBJECT_ID ('ACS_B_Age', 'U') IS NOT NULL 
DROP TABLE ACS_G_Age
GO

CREATE TABLE ACS_G_Age
(
	...
	CONSTRAINT ACS_G_Age_pk primary key (geoid,acsyear)
)
GO

INSERT INTO ACS_G_Age 
(
	...
	SELECT
	SUBSTRING(U.GEOID,10,21),U.ACS5_END_YEAR,U.B01002001_EST,
