...
IF OBJECT_ID ('ACS_G_Age_M', 'U') IS NOT NULL 
DROP TABLE ACS_G_Age_M
GO

CREATE TABLE ACS_G_Age_M
(
	...
	CONSTRAINT ACS_G_Age_M_pk primary key (geoid,acsyear)
)
GO

INSERT INTO ACS_G_Age_M 
(
	...
	M.B01001024_EST,
	M.B01001025_EST
	FROM _G_B01001 AS M JOIN _G_B01002 AS U
