...
IF OBJECT_ID ('ACS_T_Age_F', 'U') IS NOT NULL 
DROP TABLE ACS_T_Age_F
GO

CREATE TABLE ACS_T_Age_F
(
	...
	CONSTRAINT ACS_T_Age_F_pk primary key (geoid,acsyear)
)
GO

GO
INSERT INTO ACS_T_Age_F 
(
	...
	F.B01001048_EST,
	F.B01001049_EST
	FROM _T_B01001 AS F JOIN _T_B01002 AS U
