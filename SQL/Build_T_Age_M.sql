...
IF OBJECT_ID ('ACS_T_Age_M', 'U') IS NOT NULL 
DROP TABLE ACS_T_Age_M
GO

CREATE TABLE ACS_T_Age_M
(
	...
	CONSTRAINT ACS_T_Age_M_pk primary key (geoid,acsyear)
)
GO

GO
INSERT INTO ACS_T_Age_M 
(
	...
	M.B01001024_EST,
	M.B01001025_EST
	FROM _T_B01001 AS M JOIN _T_B01002 AS U
