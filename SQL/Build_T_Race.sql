...
IF OBJECT_ID ('ACS_T_Race', 'U') IS NOT NULL 
DROP TABLE ACS_T_Race
GO

CREATE TABLE ACS_T_Race
(
	...
	CONSTRAINT ACS_T_Race_pk primary key (geoid,acsyear)
)
GO

INSERT INTO ACS_T_Race
(
	...
	SELECT
	SUBSTRING(GEOID,10,20),ACS5_END_YEAR,B02001001_EST,B02001002_EST,B02001003_EST,B02001004_EST,B02001005_EST,
